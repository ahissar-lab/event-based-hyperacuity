[![DOI](https://zenodo.org/badge/954564915.svg)](https://zenodo.org)
...
The tiny-event-based and tiny-frame-based datasets used to produce the results depicted in the paper can be downloaded from the following link: [https://doi.org/10.5281/zenodo.20973756](https://doi.org/10.5281/zenodo.20973756) 
